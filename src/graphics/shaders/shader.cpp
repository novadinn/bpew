...
void Shader::setMatrix2(const char *s, const glm::mat2 &m) {
  glUniformMatrix2fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                     glm::value_ptr(m));
}

void Shader::setMatrix3(const char *s, const glm::mat3 &m) {
  glUniformMatrix3fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                     glm::value_ptr(m));
}

void Shader::setMatrix4(const char *s, const glm::mat4 &m) {
  glUniformMatrix4fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                     glm::value_ptr(m));
}

void Shader::setMatrix2x3(const char *s, const glm::mat2x3 &m) {
  glUniformMatrix2x3fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}

void Shader::setMatrix3x2(const char *s, const glm::mat3x2 &m) {
  glUniformMatrix3x2fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}

void Shader::setMatrix2x4(const char *s, const glm::mat2x4 &m) {
  glUniformMatrix2x4fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}

void Shader::setMatrix4x2(const char *s, const glm::mat4x2 &m) {
  glUniformMatrix4x2fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}

void Shader::setMatrix3x4(const char *s, const glm::mat3x4 &m) {
  glUniformMatrix3x4fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}

void Shader::setMatrix4x3(const char *s, const glm::mat4x3 &m) {
  glUniformMatrix4x3fv(glGetUniformLocation(id, s), 1, GL_FALSE,
                       glm::value_ptr(m));
}
