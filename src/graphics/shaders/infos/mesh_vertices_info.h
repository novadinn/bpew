...
const ShaderInterfaceCreateInfo mesh_vertices_vs_out =
    ShaderInterfaceCreateInfo::create("VS_OUT").flat(ShaderType::INT,
                                                     "vertexID");

const ShaderCreateInfo mesh_vertices_shader_create_info =
