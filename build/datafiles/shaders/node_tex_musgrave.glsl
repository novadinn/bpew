...
void node_tex_musgrave(int dimensions,
											 int type,
											 vec3 co,
											 float w,
											 float scale,
	...
	case 0:
		switch(type) {
		case 0:
			node_tex_musgrave_multi_fractal_1d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 1:
			node_tex_musgrave_ridged_multi_fractal_1d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 2:
			node_tex_musgrave_hybrid_multi_fractal_1d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 3:
			node_tex_musgrave_fBm_1d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 4:
			node_tex_musgrave_hetero_terrain_1d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		}
		break;
	case 1:
		switch(type) {
		case 0:
			node_tex_musgrave_multi_fractal_2d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 1:
			node_tex_musgrave_ridged_multi_fractal_2d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 2:
			node_tex_musgrave_hybrid_multi_fractal_2d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 3:
			node_tex_musgrave_fBm_2d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 4:
			node_tex_musgrave_hetero_terrain_2d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		}
		break;
	case 2:
		switch(type) {
		case 0:
			node_tex_musgrave_multi_fractal_3d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 1:
			node_tex_musgrave_ridged_multi_fractal_3d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 2:
			node_tex_musgrave_hybrid_multi_fractal_3d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 3:
			node_tex_musgrave_fBm_3d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 4:
			node_tex_musgrave_hetero_terrain_3d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		}
		break;
	case 3:
		switch(type) {
		case 0:
			node_tex_musgrave_multi_fractal_4d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 1:
			node_tex_musgrave_ridged_multi_fractal_4d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 2:
			node_tex_musgrave_hybrid_multi_fractal_4d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 3:
			node_tex_musgrave_fBm_4d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		case 4:
			node_tex_musgrave_hetero_terrain_4d(co, w, scale, detail, dimension, lac, offset, gain, fac);
			break;
		}
		break;
	}
