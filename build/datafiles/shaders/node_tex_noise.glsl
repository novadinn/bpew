...
#include "fractal_noise_lib.glsl"
...
void node_noise_texture(int dimensions,
												vec3 co,
												float w,
												float scale,
												float detail,
	...
	switch (dimensions) {
	case 0:
		node_noise_texture_1d(co, w, scale, detail, roughness, distortion, value, color);
		break;
	case 1:
		node_noise_texture_2d(co, w, scale, detail, roughness, distortion, value, color);
		break;
	case 2:
		node_noise_texture_3d(co, w, scale, detail, roughness, distortion, value, color);
		break;
	case 3:
		node_noise_texture_4d(co, w, scale, detail, roughness, distortion, value, color);
		break;
	}
}
